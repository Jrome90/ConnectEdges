...
class BL_UI_Slider(BL_UI_Widget):
    ...
    def __init__(self, x, y, width, height):
        ...
        self.__slider_pos = 0
        # Changed the intital slider value from zero to INF. The slider pos was not at zero when using a min value < 0.
        # if value != self.__slider_value was always False.
        self.__slider_value = round(float('inf'), self._decimals)
